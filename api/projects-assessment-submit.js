...
import { submitAssessmentAnswers } from "../lib/projects/brain/actions/service.js";
import {
  mapActionServiceError,
  validateAssessmentSubmitRequest,
...
export default async function handler(req, res) {
  ...
  const validation = validateAssessmentSubmitRequest(body);
  if (!validation.ok) {
