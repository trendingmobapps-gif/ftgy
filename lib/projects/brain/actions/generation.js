...
import { logExecuteStage, createExecuteStageUsageLogger } from "./execute-action-stage-log.js";
...
import { resolveOperationTimeoutMs } from "../openai-operation-timeout.js";
import {
...
export async function executePreparedAction({
  ...
  const usageLogger = createExecuteStageUsageLogger(logFn);
  ...
  logProjectModelUsage(usageLogger, {
  ...
  logFn("openai_request_started", {
    ...
    transport: "responses",
    timeoutMs,
    configuredBudgetMs: timeoutResolution.configuredBudgetMs,
    runtimeCeilingMs: timeoutResolution.runtimeCeilingMs,
    abortSource: timeoutResolution.abortSource,
