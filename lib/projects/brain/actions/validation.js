  ...
  switch (code) {
    ...
    case "EXECUTION_FAILED":
      return {
        ...
        message: "Nu am putut genera rezultatul.",
      };
    case "GENERATION_TIMEOUT":
      return {
        status: 504,
        code: PROJECT_ACTION_ERROR_CODES.GENERATION_TIMEOUT,
        message: "Analiza a durat mai mult decât era estimat. Poți relua generarea fără să pierzi progresul.",
        recoverable: true,
        retryAllowed: true,
      };
    case "EXECUTION_IN_PROGRESS":
      return {
        status: 409,
        code: PROJECT_ACTION_ERROR_CODES.EXECUTION_IN_PROGRESS,
        message: "Generarea este deja în curs. Rezultatul va apărea automat.",
        recoverable: true,
        retryAllowed: false,
      };
