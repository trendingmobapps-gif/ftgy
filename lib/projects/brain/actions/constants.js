...
export const PROJECT_ACTION_ERROR_CODES = {
  ...
  GENERATION_TIMEOUT: "PROJECT_ACTION_GENERATION_TIMEOUT",
  EXECUTION_IN_PROGRESS: "PROJECT_ACTION_EXECUTION_IN_PROGRESS",
...
export const PROJECT_ACTION_LIMITS = {
  ...
  /** Legacy default — prefer resolveOperationTimeoutMs() for provider calls. */
