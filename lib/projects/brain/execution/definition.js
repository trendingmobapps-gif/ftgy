...
import { executionPlanToExecutionDefinition } from "./execution-plan-generator.js";
...
export function resolveExecutionMode({ step, preparation, session, executionDecision, memoryMap, executionPlan = null }) {
...
export function buildExecutionDefinition({
  ...
  if (executionPlan) {
    return executionPlanToExecutionDefinition(executionPlan, {
...
export function serializeExecutionDefinition(definition) {
  ...
  return {
    ...
    finalizeActionLabel: definition.finalizeActionLabel,
