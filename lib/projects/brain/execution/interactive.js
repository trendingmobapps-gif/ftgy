...
export async function enrichResponseWithInteractiveState({
  ...
  logPrepareSessionSanitization({
    ...
    validationErrorCodes: contractValidation.valid ? [] : [contractValidation.reason],
  });
  ...
  logPrepareContract(contract, contractValidation.valid);
  ...
  return {
    ...
    contractValid: contractValidation.valid,
    contractValidationReason: contractValidation.valid ? null : contractValidation.reason,
  };
}
