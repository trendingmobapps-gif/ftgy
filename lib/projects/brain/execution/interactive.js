...
import { validateInteractivePayload } from "./execution-plan-validation.js";
...
export async function enrichResponseWithInteractiveState({
  ...
  const executionPlan = ensuredPlan.plan;
  ...
  if (!payloadValidation.valid && isInteractiveExecutionMode(mode)) {
