...
/**
 * The Step 1 contract is currently produced by a deterministic adapter and is
 * observational. It does not yet authoritatively decide questions, research,
 * result intent, resources, or workflow changes for every action.
 *
 * Keep this explicit boundary false until the frontier decision generator is
 * implemented, validated, persisted, and consumed by all downstream paths.
 */
export function isProjectBrainDecisionContractAuthoritative() {
  return false;
}
